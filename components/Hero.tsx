  ...
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#ffffff_0%,#f5fbff_48%,#eaf6ff_100%)]">
      ...
      <div className="section-shell relative grid gap-8 pb-12 pt-8 md:grid-cols-[1.02fr_0.98fr] md:items-center md:pb-16 md:pt-14">
        <div>
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-orange-100 bg-white px-4 py-2 text-[0.92rem] font-bold leading-6 text-orange-700 shadow-sm">
          ...
          <div className="mt-6 grid gap-3 text-[0.95rem] font-semibold leading-6 text-slate-700 sm:grid-cols-2">
